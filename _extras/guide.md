...
Librarians like handouts. To make a handout for this lesson, adapt/print from [https://librarycarpentry.org/lc-shell/reference.html](https://librarycarpentry.org/lc-shell/reference.html).
